    ...
    <main className="px-6 py-20 lg:px-10">
      <section className="mx-auto max-w-6xl space-y-8 rounded-[2rem] border border-white/10 bg-[#070707] p-10 shadow-[0_40px_120px_-40px_rgba(0,0,0,0.8)]">
        <div className="space-y-4">
          <p className="text-sm uppercase tracking-[0.3em] text-white/50">Users</p>
          <h1 className="text-5xl font-bold text-white">Manage admin profiles</h1>
          <p className="max-w-3xl text-lg leading-8 text-white/70">Review admin users that can access the portal and manage the site data.</p>
        </div>
